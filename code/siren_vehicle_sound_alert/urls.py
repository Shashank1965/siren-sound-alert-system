"""
URL configuration for siren_vehicle_sound_alert project.
...
from siren_vehicle_sound_alert import views as mainView
...
urlpatterns = [
    ...
    path('gen_image_view',admins.gen_image_View,name='gen_image_view'),
